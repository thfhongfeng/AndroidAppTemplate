 ...
 *
 * @attr R.styleable#TransformativeImageView_tiv_maxScale
 * @attr R.styleable#TransformativeImageView_tiv_minScale
 * @attr R.styleable#TransformImageView_enableImageScale
 * @attr R.styleable#TransformImageView_enableImageTranslate
 * @attr R.styleable#TransformImageView_enableImageRotate
 * @attr R.styleable#TransformativeImageView_tiv_revertDuration
 * @attr R.styleable#TransformativeImageView_tiv_revert
 * @attr R.styleable#TransformativeImageView_tiv_scaleCenter
 */
...
public class TransformImageView extends AppCompatImageView implements IGestureView {
    ...
    private void obtainAttrs(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext()
                .obtainStyledAttributes(attrs, R.styleable.TransformImageView);
        mUserMaxScaleFactor = typedArray.getFloat(
                R.styleable.TransformImageView_tiv_maxScale, MAX_SCALE_FACTOR);
        mUserMinScaleFactor = typedArray.getFloat(
                R.styleable.TransformImageView_tiv_minScale, UNSPECIFIED_SCALE_FACTOR);
        mEnableImageScale = typedArray.getBoolean(
                R.styleable.TransformImageView_enableImageScale, true);
        mEnableImageTranslate = typedArray.getBoolean(
                R.styleable.TransformImageView_enableImageTranslate, true);
        mEnableImageRotate = typedArray.getBoolean(
                R.styleable.TransformImageView_enableImageRotate, true);
        mRevertDuration = typedArray.getInteger(
                R.styleable.TransformImageView_tiv_revertDuration, DEFAULT_REVERT_DURATION);
        mOpenScaleRevert = typedArray.getBoolean(
                R.styleable.TransformImageView_tiv_openScaleRevert, false);
        mOpenRotateRevert = typedArray.getBoolean(
                R.styleable.TransformImageView_tiv_openRotateRevert, false);
        mOpenTranslateRevert = typedArray.getBoolean(
                R.styleable.TransformImageView_tiv_openTranslateRevert, false);
        mOpenAnimator = typedArray.getBoolean(
                R.styleable.TransformImageView_tiv_openAnimator, true);
        mScaleBy = typedArray.getInt(
                R.styleable.TransformImageView_tiv_scaleCenter, SCALE_BY_IMAGE_CENTER);
        typedArray.recycle();
    }
