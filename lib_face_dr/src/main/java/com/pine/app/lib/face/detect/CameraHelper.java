...
//        cameraParam.setFocusMode(Camera.Parameters.FOCUS_MODE_FIXED);
    ...
    public synchronized Camera openCamera(int cameraIndex) {
        ...
        for (int index = 0; index < numberOfCameras; index++) {
            ...
            Log.d(TAG, "openCamera cameraIndex:" + cameraIndex + ", getCameraInfo this index:" + index
            ...
            if (cameraIndex == index) {
                ...
                Log.d(TAG, "openCamera cameraIndex:" + cameraIndex + ", find camera index:" + index
                        + ", facing:" + cameraInfo.facing + ", orientation:" + cameraInfo.orientation);
    ...
    public synchronized Camera openFrontCamera() {
        ...
        for (int cameraId = 0; cameraId < numberOfCameras; cameraId++) {
            ...
            Log.d(TAG, "openFrontCamera getCameraInfo this index:" + cameraId
                    + ", facing:" + cameraInfo.facing + ", orientation:" + cameraInfo.orientation);
            if (cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                Log.d(TAG, "openFrontCamera find front camera index:" + cameraId
                        + ", facing:" + cameraInfo.facing + ", orientation:" + cameraInfo.orientation);
    ...
    public synchronized Camera openBackCamera() {
        ...
        for (int cameraId = 0; cameraId < numberOfCameras; cameraId++) {
            Camera.getCameraInfo(cameraId, cameraInfo);
            Log.d(TAG, "openBackCamera getCameraInfo this index:" + cameraId
                    + ", facing:" + cameraInfo.facing + ", orientation:" + cameraInfo.orientation);
            if (cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_BACK) {
                Log.d(TAG, "openBackCamera find back camera index:" + cameraId
                        + ", facing:" + cameraInfo.facing + ", orientation:" + cameraInfo.orientation);
                mCameraIdIndex = cameraId;
                mCameraType = CameraConfig.BACK;
                return Camera.open(cameraId);
    ...
    public Camera.CameraInfo getCameraInfo(int cameraIndex) {
        ...
        for (int cameraId = 0; cameraId < numberOfCameras; cameraId++) {
            Camera.getCameraInfo(cameraId, cameraInfo);
            Log.d(TAG, "getCameraInfo cameraIndex: " + cameraIndex + ", this index:" + cameraId
                    + ", facing:" + cameraInfo.facing + ", orientation:" + cameraInfo.orientation);
