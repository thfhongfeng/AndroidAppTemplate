...
public class ThousandthNumberTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public ThousandthNumberTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BaseThousandthNumberTv);
        mDecimalNum = typedArray.getInteger(R.styleable.BaseThousandthNumberTv_base_decimalNum, 2);
        mNumberMaxLength = typedArray.getInteger(R.styleable.BaseThousandthNumberTv_base_numberMaxLength, 99);
        mDecimalAllow = typedArray.getBoolean(R.styleable.BaseThousandthNumberTv_base_decimalAllow, false);
        mSpaceChar = typedArray.getString(R.styleable.BaseThousandthNumberTv_base_spaceChar);
