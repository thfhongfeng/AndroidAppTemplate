...
public class RingScaleDiagramView extends View {
    ...
    public RingScaleDiagramView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BaseRingScaleDiagramView);
        mInnerRadius = typedArray.getDimensionPixelOffset(R.styleable.BaseRingScaleDiagramView_base_innerRadius, 40);
        mOuterRadius = typedArray.getDimensionPixelOffset(R.styleable.BaseRingScaleDiagramView_base_outerRadius, 80);
        mFoldLineWidth = typedArray.getDimensionPixelOffset(R.styleable.BaseRingScaleDiagramView_base_foldLineWidth, 3);
        mFoldFirstLineLength = typedArray.getDimensionPixelOffset(R.styleable.BaseRingScaleDiagramView_base_foldFirstLineLength, (int) (mOuterRadius * 0.5f));
        mFoldSecondLineLength = (int) (mFoldFirstLineLength * 0.4f);
        mScaleTextColor = typedArray.getColor(R.styleable.BaseRingScaleDiagramView_base_nameTextColor, Color.BLACK);
        mScaleTextSize = typedArray.getDimensionPixelSize(R.styleable.BaseRingScaleDiagramView_base_nameTextSize, 28);
        mNameTextColor = typedArray.getColor(R.styleable.BaseRingScaleDiagramView_base_nameTextColor, Color.BLACK);
        mNameTextSize = typedArray.getDimensionPixelSize(R.styleable.BaseRingScaleDiagramView_base_nameTextSize, 28);
        mIsTwoTextLine = typedArray.getBoolean(R.styleable.BaseRingScaleDiagramView_base_isTwoTextLine, true);
        mRingBackgroundColor = typedArray.getColor(R.styleable.BaseRingScaleDiagramView_base_ringBackgroundColor, Color.LTGRAY);
        int base_startAngle = typedArray.getInteger(R.styleable.BaseRingScaleDiagramView_base_startAngle, -90);
        mRingStartAngle = new BigDecimal(String.valueOf((base_startAngle % 360 + 450) % 360 - 90));
    ...
    public static class ScaleData {
        ...
        public float getStartAngle() {
            return base_startAngle;
        }

        public void setStartAngle(float base_startAngle) {
            this.base_startAngle = base_startAngle;
        }
