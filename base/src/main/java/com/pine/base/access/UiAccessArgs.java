...
public interface UiAccessArgs {
    ...
    // UiAccessTimeInterval.UI_ACCESS_ON_CREATE阶段的UI Vip准入检查不通过时，不跳转到登陆界面
    String VIP_ACCESS_FALSE_ON_CREATE_NOT_GO_LOGIN = "vip_access_false_on_create_not_go_login";
    ...
    // UiAccessTimeInterval.UI_ACCESS_ON_NEW_INTENT阶段的UI Vip准入检查不通过时，不跳转到登陆界面
    String VIP_ACCESS_FALSE_ON_NEW_INTENT_NOT_GO_LOGIN = "vip_access_false_on_new_intent_not_go_login";
    ...
    // UiAccessTimeInterval.UI_ACCESS_ON_RESUME阶段的UI Vip准入检查不通过时，不跳转到登陆界面
    String VIP_ACCESS_FALSE_ON_RESUME_NOT_GO_LOGIN = "vip_access_false_on_resume_not_go_login";
