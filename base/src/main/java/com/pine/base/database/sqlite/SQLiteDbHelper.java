...
import static com.pine.base.database.IDbRequestManager.SHOP_TYPE_TABLE_NAME;
import static com.pine.base.database.IDbRequestManager.SWITCHER_CONFIG_TABLE_NAME;
import static com.pine.base.database.IDbRequestManager.TRAVEL_NOTE_COMMENT_TABLE_NAME;
import static com.pine.base.database.IDbRequestManager.TRAVEL_NOTE_SHOP_TABLE_NAME;
import static com.pine.base.database.IDbRequestManager.TRAVEL_NOTE_TABLE_NAME;
    ...
    private void createAccountLoginTable(SQLiteDatabase db) {
        try {
            db.execSQL("create table if not exists " + ACCOUNT_LOGIN_TABLE_NAME +
                    "(_id integer primary key autoincrement,accountId integer not null," +
