...
public class LoginARouterOpRemote extends ARouterBundleRemote<LoginOpRemoteService> implements IARouterService {
    private LoginOpRemoteService mRemoteService;
