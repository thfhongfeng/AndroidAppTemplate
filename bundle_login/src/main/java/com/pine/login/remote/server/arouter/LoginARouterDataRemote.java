...
public class LoginARouterDataRemote extends ARouterBundleRemote<LoginDataRemoteService> implements IARouterService {
    private LoginDataRemoteService mRemoteService;
