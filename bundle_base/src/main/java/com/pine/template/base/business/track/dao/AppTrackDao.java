...
public interface AppTrackDao {
    ...
    @Query("SELECT * FROM db_app_track WHERE time_in_stamp >= :startTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByStartTime(long startTime);

    @Query("SELECT * FROM db_app_track WHERE time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByEndTime(long endTime);

    @Query("SELECT * FROM db_app_track WHERE time_in_stamp >= :startTime AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByTime(long startTime, long endTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag = :moduleTag ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllListByModule(String moduleTag);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllListByModules(List<String> moduleTags);

    @Query("SELECT * FROM db_app_track WHERE track_type = :trackType AND module_tag IN (:moduleTags) ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllListByModules(int trackType, List<String> moduleTags);

    @Query("SELECT * FROM db_app_track WHERE module_tag = :actionName ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllListByAction(String actionName);

    @Query("SELECT * FROM db_app_track WHERE action_name IN (:actionNames) ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllListByActions(List<String> actionNames);

    @Query("SELECT * FROM db_app_track WHERE module_tag = :moduleTag AND action_name = :actionName ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllList(String moduleTag, String actionName);

    @Query("SELECT * FROM db_app_track WHERE module_tag = :moduleTag AND action_name IN (:actionNames) ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllList(String moduleTag, List<String> actionNames);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND action_name = :actionName ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllList(List<String> moduleTags, String actionName);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND action_name IN (:actionNames) ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllList(List<String> moduleTags, List<String> actionNames);

    @Query("SELECT * FROM db_app_track WHERE track_type = :trackType AND module_tag IN (:moduleTags) AND action_name = :actionName ORDER BY time_in_stamp DESC")
    List<AppTrack> queryAllList(int trackType, List<String> moduleTags, String actionName);

    @Query("SELECT * FROM db_app_track WHERE track_type = :trackType AND module_tag IN (:moduleTags) AND action_name IN (:actionNames) ORDER BY time_in_stamp DESC")
    ...
    @Query("SELECT * FROM db_app_track WHERE module_tag = :moduleTag AND time_in_stamp >= :startTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByModuleAndStartTime(String moduleTag, long startTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag = :moduleTag AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByModuleAndEndTime(String moduleTag, long endTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag = :moduleTag AND time_in_stamp >= :startTime AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByModuleAndTime(String moduleTag, long startTime, long endTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND time_in_stamp >= :startTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByModulesAndStartTime(List<String> moduleTags, long startTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByModulesAndEndTime(List<String> moduleTags, long endTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND time_in_stamp >= :startTime AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByModulesAndTime(List<String> moduleTags, long startTime, long endTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND  action_name IN (:actionNames) AND time_in_stamp >= :startTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByStartTime(@NonNull List<String> moduleTags, @NonNull List<String> actionNames, long startTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND  action_name IN (:actionNames) AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByEndTime(@NonNull List<String> moduleTags, @NonNull List<String> actionNames, long endTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND  action_name IN (:actionNames) AND time_in_stamp >= :startTime AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC")
    List<AppTrack> queryListByTime(@NonNull List<String> moduleTags, @NonNull List<String> actionNames, long startTime, long endTime);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND  action_name IN (:actionNames) AND time_in_stamp < :endTime ORDER BY time_in_stamp DESC LIMIT :count")
    List<AppTrack> queryTrackListByEndTime(@NonNull List<String> moduleTags, @NonNull List<String> actionNames, long endTime, int count);

    @Query("SELECT * FROM db_app_track WHERE module_tag IN (:moduleTags) AND  action_name IN (:actionNames) AND time_in_stamp >= :startTime  ORDER BY time_in_stamp ASC LIMIT :count")
    List<AppTrack> queryTrackListByStartTime(@NonNull List<String> moduleTags, @NonNull List<String> actionNames, long startTime, int count);
