package com.pine.template.base.business.access;
...
public interface UiAccessAction {
    ...
    // UiAccessTimeInterval.UI_ACCESS_ON_CREATE阶段的ConfigSwitcher准入检查不通过时，弹出toast提示
    String CONFIG_SWITCHER_ACCESS_FALSE_ON_CREATE_SHOW_TOAST = "config_switcher_access_false_on_create_show_toast";
    // UiAccessTimeInterval.UI_ACCESS_ON_CREATE阶段的ConfigSwitcher准入检查不通过时，不结束当前UI
    String CONFIG_SWITCHER_ACCESS_FALSE_ON_CREATE_NOT_FINISH_UI = "config_switcher_access_false_on_create_not_finish_ui";
    // UiAccessTimeInterval.UI_ACCESS_ON_NEW_INTENT阶段的ConfigSwitcher准入检查不通过时，弹出toast提示
    String CONFIG_SWITCHER_ACCESS_FALSE_ON_NEW_INTENT_SHOW_TOAST = "config_switcher_access_false_on_new_intent_show_toast";
    // UiAccessTimeInterval.UI_ACCESS_ON_NEW_INTENT阶段的ConfigSwitcher准入检查不通过时，不结束当前UI
    String CONFIG_SWITCHER_ACCESS_FALSE_ON_NEW_INTENT_NOT_FINISH_UI = "config_switcher_access_false_on_new_intent_not_finish_ui";
    // UiAccessTimeInterval.UI_ACCESS_ON_RESUME阶段的ConfigSwitcher准入检查不通过时，弹出toast提示
    String CONFIG_SWITCHER_ACCESS_FALSE_ON_RESUME_SHOW_TOAST = "config_switcher_access_false_on_resume_show_toast";
    // UiAccessTimeInterval.UI_ACCESS_ON_RESUME阶段的ConfigSwitcher准入检查不通过时，不结束当前UI
    String CONFIG_SWITCHER_ACCESS_FALSE_ON_RESUME_NOT_FINISH_UI = "config_switcher_access_false_on_resume_not_finish_ui";
