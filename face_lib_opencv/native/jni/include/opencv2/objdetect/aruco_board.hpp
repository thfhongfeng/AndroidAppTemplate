 ...
 */
        class CV_EXPORTS_W_SIMPLE GridBoard
 ...
 */
    class CV_EXPORTS_W_SIMPLE CharucoBoard
     ...
     */
    CV_WRAP std::vector<Point3f>

    getChessboardCorners() const;
