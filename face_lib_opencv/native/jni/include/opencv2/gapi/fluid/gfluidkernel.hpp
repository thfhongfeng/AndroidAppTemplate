...
/** @} gapi_compile_args */
    ...
    namespace detail {
        ...
        private:
            ...
            ->
            typename std::is_same<decltype(U::Window), T>::type;
        ...
        static_assert(all_satisfy<is_gmat_type, Outs...>::value,
        "return type must be GMat");
        static_assert(contains<GMat, Ins...>::value,
        "input must contain at least one GMat");
