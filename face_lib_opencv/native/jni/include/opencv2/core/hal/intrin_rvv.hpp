...
{ \
    ...
    OPENCV_HAL_IMPL_RVV_NATIVE_WCVT(vuint16m1_t, vuint8mf2_t, ushort, vwcvtu_x_x_v_u16m1, u16, 16,
                                    8)

    OPENCV_HAL_IMPL_RVV_NATIVE_WCVT(vint16m1_t, vint8mf2_t, short, vwcvt_x_x_v_i16m1, i16, 16, 8)

    OPENCV_HAL_IMPL_RVV_NATIVE_WCVT(vuint32m1_t, vuint16mf2_t, unsigned, vwcvtu_x_x_v_u32m1, u32,
                                    32, 4)

    OPENCV_HAL_IMPL_RVV_NATIVE_WCVT(vint32m1_t, vint16mf2_t, int, vwcvt_x_x_v_i32m1, i32, 32, 4)

    OPENCV_HAL_IMPL_RVV_NATIVE_WCVT(vuint64m1_t, vuint32mf2_t, uint64, vwcvtu_x_x_v_u64m1, u64, 64,
                                    2)
...
// Three times reinterpret
 ...
 {
        \
    return v_float32x4(vreinterpret_v_u32m1_f32m1(
                vreinterpret_v_u64m1_u32m1(vreinterpret_v_f64m1_u64m1(v))));\
 ...
 {
        \
    return v_float64x2(vreinterpret_v_u64m1_f64m1(
                vreinterpret_v_u32m1_u64m1(vreinterpret_v_f32m1_u32m1(v))));\
...
{ \
    ...
    OPENCV_HAL_IMPL_RVV_LOADSTORE_OP(v_uint32x4, vuint32m1_t, unsigned, 2, 4, 32, u32,
                                     vmv_v_x_u32m1)
    ...
    OPENCV_HAL_IMPL_RVV_LOADSTORE_OP(v_float32x4, vfloat32m1_t, float, 2, 4, 32, f32,
                                     vfmv_v_f_f32m1)

#if CV_SIMD128_64F

    OPENCV_HAL_IMPL_RVV_LOADSTORE_OP(v_float64x2, vfloat64m1_t, double, 1, 2, 64, f64,
                                     vfmv_v_f_f64m1)
    ...
    inline v_uint8x16 v_load_halves(const uchar *ptr0, const uchar *ptr1) {
        return v_reinterpret_as_u8(v_load_halves((schar *) ptr0, (schar *) ptr1));
    }
    ...
    inline v_uint16x8 v_load_halves(const ushort *ptr0, const ushort *ptr1) {
        return v_reinterpret_as_u16(v_load_halves((short *) ptr0, (short *) ptr1));
    }
    ...
    inline v_uint32x4 v_load_halves(const unsigned *ptr0, const unsigned *ptr1) {
        return v_reinterpret_as_u32(v_load_halves((int *) ptr0, (int *) ptr1));
    }
    ...
    inline v_uint64x2 v_load_halves(const uint64 *ptr0, const uint64 *ptr1) {
        return v_reinterpret_as_u64(v_load_halves((int64 *) ptr0, (int64 *) ptr1));
    }
...
////////////// Pack boolean ////////////////////
    ...
    inline v_uint8x16 v_pack_b(const v_uint64x2 &a, const v_uint64x2 &b, const v_uint64x2 &c,
        ...
        v_store(ptr + 14, h);
        return v_uint8x16(
                vnsrl_wx_u8m1(vnsrl_wx_u16m2(vnsrl_wx_u32m4(vle64_v_u64m8(ptr, 16), 0, 16), 0, 16),
                              0, 16));
    }
...
{ \
    ...
    inline v_float32x4 operator~(const v_float32x4 &a) {
        return v_float32x4(
                vreinterpret_v_i32m1_f32m1(vnot_v_i32m1(vreinterpret_v_f32m1_i32m1(a), 4)));
    }
...
{ \
    ...
    inline v_float64x2 operator~(const v_float64x2 &a) {
        return v_float64x2(
                vreinterpret_v_i64m1_f64m1(vnot_v_i64m1(vreinterpret_v_f64m1_i64m1(a), 2)));
    }
...
OPENCV_HAL_IMPL_RVV_FLOAT_CMP_OP(_Tpvec, >=, vmfge_vv_##suffix##m1_b##width, suffix, vl)
    ...
    inline v_float32x4 v_not_nan(const v_float32x4 &a) { return a == a; }

#if CV_SIMD128_64F

    inline v_float64x2 v_not_nan(const v_float64x2 &a) { return a == a; }
...
{ \
    ...
    OPENCV_HAL_IMPL_RVV_REDUCE_SUM(v_uint8x16, v_uint16x8, vuint16m1_t, unsigned, u8, u16, 16,
                                   wredsumu)

    OPENCV_HAL_IMPL_RVV_REDUCE_SUM(v_int8x16, v_int16x8, vint16m1_t, int, i8, i16, 16, wredsum)

    OPENCV_HAL_IMPL_RVV_REDUCE_SUM(v_uint16x8, v_uint32x4, vuint32m1_t, unsigned, u16, u32, 8,
                                   wredsumu)

    OPENCV_HAL_IMPL_RVV_REDUCE_SUM(v_int16x8, v_int32x4, vint32m1_t, int, i16, i32, 8, wredsum)

    OPENCV_HAL_IMPL_RVV_REDUCE_SUM(v_uint32x4, v_uint64x2, vuint64m1_t, unsigned, u32, u64, 4,
                                   wredsumu)
...
// vfredsum for float has renamed to fredosum, also updated in GNU.
    OPENCV_HAL_IMPL_RVV_REDUCE_SUM_FP(v_float32x4, v_float32x4, vfloat32m1_t, float, f32, f32, 4,
                                      fredosum)

#if CV_SIMD128_64F

    OPENCV_HAL_IMPL_RVV_REDUCE_SUM_FP(v_float64x2, v_float64x2, vfloat64m1_t, double, f64, f64, 2,
                                      fredosum)
...
////////////// Square-Root //////////////
    ...
    inline v_float32x4 v_magnitude(const v_float32x4 &a, const v_float32x4 &b) {
        v_float32x4
        x(vfmacc_vv_f32m1(vfmul_vv_f32m1(a, a, 4), b, b, 4));
        return v_sqrt(x);
    }
    ...
    inline v_float64x2 v_magnitude(const v_float64x2 &a, const v_float64x2 &b) {
        v_float64x2
        x(vfmacc_vv_f64m1(vfmul_vv_f64m1(a, a, 2), b, b, 2));
        return v_sqrt(x);
    }
...
{ \
    ...
    OPENCV_HAL_IMPL_RVV_ABSDIFF_S(v_int8x16, v_uint8x16, vuint16m2_t, vwsub_vv_i16m2,
                                  vnclipu_wx_u8m1, 16)

    OPENCV_HAL_IMPL_RVV_ABSDIFF_S(v_int16x8, v_uint16x8, vuint32m2_t, vwsub_vv_i32m2,
                                  vnclipu_wx_u16m1, 8)

    OPENCV_HAL_IMPL_RVV_ABSDIFF_S(v_int32x4, v_uint32x4, vuint64m2_t, vwsub_vv_i64m2,
                                  vnclipu_wx_u32m1, 4)
...
{ \
    ...
    OPENCV_HAL_IMPL_RVV_PACK(v_uint8x16, uchar, v_uint16x8, ushort, 8, 16, u8, u16, vnclipu_wx_u8m1,
                             vnclipu_wx_u8m1, 8, 16)

    OPENCV_HAL_IMPL_RVV_PACK(v_int8x16, schar, v_int16x8, short, 8, 16, i8, i16, vnclip_wx_i8m1,
                             vnclip_wx_i8m1, 8, 16)

    OPENCV_HAL_IMPL_RVV_PACK(v_uint16x8, ushort, v_uint32x4, unsigned, 16, 32, u16, u32,
                             vnclipu_wx_u16m1, vnclipu_wx_u16m1, 4, 8)

    OPENCV_HAL_IMPL_RVV_PACK(v_int16x8, short, v_int32x4, int, 16, 32, i16, i32, vnclip_wx_i16m1,
                             vnclip_wx_i16m1, 4, 8)

    OPENCV_HAL_IMPL_RVV_PACK(v_uint32x4, unsigned, v_uint64x2, uint64, 32, 64, u32, u64,
                             vnclipu_wx_u32m1, vnsrl_wx_u32m1, 2, 4)

    OPENCV_HAL_IMPL_RVV_PACK(v_int32x4, int, v_int64x2, int64, 32, 64, i32, i64, vnclip_wx_i32m1,
                             vnsra_wx_i32m1, 2, 4)
...
{ \
    ...
    OPENCV_HAL_IMPL_RVV_PACK_U(v_uint8x16, uchar, v_int16x8, short, 8, 16, u8, i16, vnclipu_wx_u8m1,
                               vreinterpret_v_i16m2_u16m2, 8, 16)

    OPENCV_HAL_IMPL_RVV_PACK_U(v_uint16x8, ushort, v_int32x4, int, 16, 32, u16, i32,
                               vnclipu_wx_u16m1, vreinterpret_v_i32m2_u32m2, 4, 8)
...
// use reinterpret instead of c-style casting.
    ...
    inline v_int8x16 v_pack_triplets(const v_int8x16 &vec) {
        ...
        return v_int8x16((vint8m1_t) vrgather_vv_u8m1((vuint8m1_t) vint8m1_t(vec),
                                                      (vuint8m1_t) vle64_v_u64m1(ptr, 2), 16));
    }
    ...
    inline v_int16x8 v_pack_triplets(const v_int16x8 &vec) {
        ...
        return v_int16x8((vint16m1_t) vrgather_vv_u8m1((vuint8m1_t) vint16m1_t(vec),
                                                       (vuint8m1_t) vle64_v_u64m1(ptr, 2), 16));
    }
