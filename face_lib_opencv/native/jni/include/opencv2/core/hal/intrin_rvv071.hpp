...
// 16 >> 32
    ...
    inline v_int32x4 v_dotprod(const v_int16x8 &a, const v_int16x8 &b, const v_int32x4 &c) {
        ...
        res = vrgather_vv_i32m2(res, (vuint32m2_t) {0, 2, 4, 6, 1, 3, 5, 7}, 8);
        return v_int32x4(
                vadd_vv_i32m1(vadd_vv_i32m1(vget_i32m2_i32m1(res, 0), vget_i32m2_i32m1(res, 1), 4),
                              c.val, 4));
    }
...
// 32 >> 64
    ...
    inline v_int64x2 v_dotprod(const v_int32x4 &a, const v_int32x4 &b, const v_int64x2 &c) {
        ...
        res = vrgather_vv_i64m2(res, (vuint64m2_t) {0, 2, 1, 3}, 4);
        return v_int64x2(
                vadd_vv_i64m1(vadd_vv_i64m1(vget_i64m2_i64m1(res, 0), vget_i64m2_i64m1(res, 1), 2),
                              c.val, 2));
    }
...
// 8 >> 32
    inline v_uint32x4 v_dotprod_expand(const v_uint8x16 &a, const v_uint8x16 &b) {
        ...
        v1 = vrgather_vv_u16m2(v1,
                               (vuint16m2_t) {0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15},
                               16);
    ...
    inline v_uint32x4 v_dotprod_expand(const v_uint8x16 &a, const v_uint8x16 &b,
        ...
        v2 = vwaddu_vv_u32m2(vget_u16m2_u16m1(v1, 0), vget_u16m2_u16m1(v1, 1), 8);
        return v_uint32x4(
                vadd_vv_u32m1(vadd_vv_u32m1(vget_u32m2_u32m1(v2, 0), vget_u32m2_u32m1(v2, 1), 4),
                              c.val, 4));
    }
    ...
    inline v_int32x4 v_dotprod_expand(const v_int8x16 &a, const v_int8x16 &b,
        ...
        v2 = vwadd_vv_i32m2(vget_i16m2_i16m1(v1, 0), vget_i16m2_i16m1(v1, 1), 8);
        return v_int32x4(
                vadd_vv_i32m1(vadd_vv_i32m1(vget_i32m2_i32m1(v2, 0), vget_i32m2_i32m1(v2, 1), 4),
                              c.val, 4));
    }
    ...
    inline v_uint64x2 v_dotprod_expand(const v_uint16x8 &a, const v_uint16x8 &b,
        ...
        v2 = vwaddu_vv_u64m2(vget_u32m2_u32m1(v1, 0), vget_u32m2_u32m1(v1, 1), 4);
        return v_uint64x2(
                vadd_vv_u64m1(vadd_vv_u64m1(vget_u64m2_u64m1(v2, 0), vget_u64m2_u64m1(v2, 1), 2),
                              c.val, 2));
    }
    ...
    inline v_int64x2 v_dotprod_expand(const v_int16x8 &a, const v_int16x8 &b,
        ...
        v2 = vwadd_vv_i64m2(vget_i32m2_i32m1(v1, 0), vget_i32m2_i32m1(v1, 1), 4);
        return v_int64x2(
                vadd_vv_i64m1(vadd_vv_i64m1(vget_i64m2_i64m1(v2, 0), vget_i64m2_i64m1(v2, 1), 2),
                              c.val, 2));
    }
...
// 16 >> 32
    ...
    inline v_int32x4 v_dotprod_fast(const v_int16x8 &a, const v_int16x8 &b, const v_int32x4 &c) {
        ...
        v1 = vwmul_vv_i32m2(a.val, b.val, 8);
        return v_int32x4(
                vadd_vv_i32m1(vadd_vv_i32m1(vget_i32m2_i32m1(v1, 0), vget_i32m2_i32m1(v1, 1), 4),
                              c.val, 4));
    }
...
// 32 >> 64
    ...
    inline v_int64x2 v_dotprod_fast(const v_int32x4 &a, const v_int32x4 &b, const v_int64x2 &c) {
        ...
        return v_int64x2(
                vadd_vv_i64m1(vadd_vv_i64m1(vget_i64m2_i64m1(v1, 0), vget_i64m2_i64m1(v1, 1), 4),
                              c.val, 4));
    }
...
{\
    ...
    OPENCV_HAL_IMPL_RISCVV_REDUCE_OP_W(uint8, uint16, u16, unsigned, sum, vwredsumu_vs_u8m1_u16m1,
                                       16)

    OPENCV_HAL_IMPL_RISCVV_REDUCE_OP_W(uint16, uint32, u32, unsigned, sum, vwredsumu_vs_u16m1_u32m1,
                                       8)

    OPENCV_HAL_IMPL_RISCVV_REDUCE_OP_W(uint32, uint64, u64, unsigned, sum, vwredsumu_vs_u32m1_u64m1,
                                       4)
    ...
    inline double v_reduce_sum(const v_float64x2 &a) \
 {
    ...
    inline uint64 v_reduce_sum(const v_uint64x2 &a) {
        return vext_x_v_u64m1_u64((vuint64m1_t) a.val, 0, 2) +
               vext_x_v_u64m1_u64((vuint64m1_t) a.val, 1, 2);
    }

    inline int64 v_reduce_sum(const v_int64x2 &a) {
        return vext_x_v_i64m1_i64((vint64m1_t) a.val, 0, 2) +
               vext_x_v_i64m1_i64((vint64m1_t) a.val, 1, 2);
    }
...
#pragma GCC diagnostic pop
    ...
    vuint8m1_t zero = vmv_v_x_u8m1(0, 16);
        ...
        return v_uint64x2((unsigned long) vmv_x_s_u8m1_u8(res1, 8),
...
{ \
    ...
    inline v_float32x4
    v_select(const v_float32x4 &mask, const v_float32x4 &a, const v_float32x4 &b) {
        return v_float32x4(
                (vfloat32m1_t) vmerge_vvm_u32m1((vbool32_t) mask.val, (vuint32m1_t) b.val,
                                                (vuint32m1_t) a.val, 4));
    }

    inline v_float64x2
    v_select(const v_float64x2 &mask, const v_float64x2 &a, const v_float64x2 &b) {
        return v_float64x2(
                (vfloat64m1_t) vmerge_vvm_u64m1((vbool64_t) mask.val, (vuint64m1_t) b.val,
                                                (vuint64m1_t) a.val, 2));
    }
...
{ \
    ...
    OPENCV_HAL_IMPL_RISCVV_EXPAND(addu, v_uint8x16, uint16x8, uchar, u8m1, 16, u16, 8, vuint16m2,
                                  vuint8m1)

    OPENCV_HAL_IMPL_RISCVV_EXPAND(addu, v_uint16x8, uint32x4, ushort, u16m1, 8, u32, 4, vuint32m2,
                                  vuint16m1)

    OPENCV_HAL_IMPL_RISCVV_EXPAND(addu, v_uint32x4, uint64x2, uint, u32m1, 4, u64, 2, vuint64m2,
                                  vuint32m1)

    OPENCV_HAL_IMPL_RISCVV_EXPAND(add, v_int8x16, int16x8, schar, i8m1, 16, i16, 8, vint16m2,
                                  vint8m1)

    OPENCV_HAL_IMPL_RISCVV_EXPAND(add, v_int16x8, int32x4, short, i16m1, 8, i32, 4, vint32m2,
                                  vint16m1)

    OPENCV_HAL_IMPL_RISCVV_EXPAND(add, v_int32x4, int64x2, int, i32m1, 4, i64, 2, vint64m2,
                                  vint32m1)
...
{ \
    ...
    inline v_float64x2 v_dotprod_expand_fast(const v_int32x4 &a, const v_int32x4 &b) {
        ...
        vfloat64m1_t res = vfcvt_f_x_v_f64m1(
                vadd_vv_i64m1(vget_i64m2_i64m1(v1, 0), vget_i64m2_i64m1(v1, 1), 2), 2);
        return v_float64x2(res);
    }
