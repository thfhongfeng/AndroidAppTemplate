 ...
 */
    ...
    public:
        ...
        CV_QUAT_EPS = (_Tp) 1.e-6;
        static constexpr _Tp
        CV_QUAT_CONVERT_THRESHOLD = (_Tp) 1.e-6;
        ...
        */
        static Quat<_Tp>
        createFromEulerAngles(const Vec<_Tp, 3> &angles, QuatEnum::EulerAnglesType eulerAnglesType);
    ...
    template<typename T>
    Quat<T>
    power(const Quat<T> &q, const Quat<T> &p, QuatAssumeType assumeUnit = QUAT_ASSUME_NOT_UNIT);
