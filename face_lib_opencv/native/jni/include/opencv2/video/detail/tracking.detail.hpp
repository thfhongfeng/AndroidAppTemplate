...
*/
            typedef std::vector<std::pair<Ptr < TrackerTargetState>, float>>
            ConfidenceMap;
 ...
 */
            class CV_EXPORTS TrackerSamplerCSC
            ...
            */
            TrackerSamplerCSC(
                    const TrackerSamplerCSC::Params &parameters = TrackerSamplerCSC::Params());
            ...
            */
            ...
            bool sampling(const Mat &image, const Rect &boundingBox, std::vector <Mat> &sample)
