...
#define CV__DEFINE_CHECK_CONTEXT(id, message, testOp, p1_str, p2_str) \
    static const cv::detail::CheckContext CV__CHECK_LOCATION_VARNAME(id) = \
        ...
        check_failed_auto(const bool v1, const bool v2, const CheckContext &ctx);
        ...
        check_failed_true(const bool v, const CheckContext &ctx);

        CV_EXPORTS void CV_NORETURN

        check_failed_false(const bool v, const CheckContext &ctx);
