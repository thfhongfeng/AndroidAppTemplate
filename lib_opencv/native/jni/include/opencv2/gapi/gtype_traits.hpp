...
namespace cv {
    ...
    template<typename T>
    struct GTypeTraits {
        static constexpr const ArgKind
        kind = ArgKind::OPAQUE_VAL;
        static constexpr const OpaqueKind
        op_kind = OpaqueKind::CV_UNKNOWN;
    };
    template<>
    struct GTypeTraits<cv::GMat> {
        static constexpr const ArgKind
        kind = ArgKind::GMAT;
        static constexpr const GShape
        shape = GShape::GMAT;
        static constexpr const OpaqueKind
        op_kind = OpaqueKind::CV_UNKNOWN;
    };
    ...
    struct GTypeTraits<cv::GScalar> {
        static constexpr const ArgKind
        kind = ArgKind::GSCALAR;
        static constexpr const GShape
        shape = GShape::GSCALAR;
        static constexpr const OpaqueKind
        op_kind = OpaqueKind::CV_UNKNOWN;
    };
    ...
    struct GTypeTraits<cv::GOpaque<T> > {
        static constexpr const ArgKind
        kind = ArgKind::GOPAQUE;
        static constexpr const GShape
        shape = GShape::GOPAQUE;
        static constexpr const OpaqueKind
        op_kind = GOpaqueTraits<T>::kind;
        using host_type = T;
    ...
    struct has_custom_wrap {
        ...
        static const constexpr bool value = std::is_same<std::true_type, decltype(
                test<T>(nullptr))>::value;
    };
