...
namespace cv {
    namespace gapi {
        namespace wip {
            namespace onevpl {
                ...
                struct GAPI_EXPORTS DataProviderException
                : public std::exception {
                DataProviderException(const std::string &descr);

                DataProviderException(std::string
                && descr);

                virtual ~

                DataProviderException() = default;
            ...
            struct GAPI_EXPORTS DataProviderSystemErrorException
            final : public DataProviderException {
            DataProviderSystemErrorException(int error_code,
        ...
        struct GAPI_EXPORTS DataProviderUnsupportedException
        final : public DataProviderException {
    ...
    struct GAPI_EXPORTS DataProviderImplementationException
