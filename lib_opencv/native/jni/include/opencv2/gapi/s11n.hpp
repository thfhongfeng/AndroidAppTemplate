...
*/
        ...
        namespace detail {
            ...
            getGraph(const std::vector<char> &bytes);

            GAPI_EXPORTS cv::GMetaArgs

            getMetaArgs(const std::vector<char> &bytes);

            GAPI_EXPORTS cv::GRunArgs

            getRunArgs(const std::vector<char> &bytes);

            GAPI_EXPORTS std::vector<std::string>

            getVectorOfStrings(const std::vector<char> &bytes);
 ...
 */
        ...
        serialize(const cv::GCompileArgs &ca);
 ...
 */
        ...
        serialize(const cv::GMetaArgs &ma);
 ...
 */
        ...
        serialize(const cv::GRunArgs &ra);
 ...
 */
        ...
        serialize(const std::vector <std::string> &vs);
 ...
 */
            ...
            namespace detail {
                ...
                getInStream(const std::vector<char> &bytes);
            } // namespace detail
