...
namespace cvflann {
    ...
    namespace anyimpl {
        ...
        struct typed_base_any_policy : base_any_policy {
            ...
            CV_OVERRIDE { return sizeof(T); }

            virtual const std::type_info &type()

            CV_OVERRIDE { return typeid(T); }

        };

        template<typename T>
        struct small_any_policy CV_FINAL
        : typed_base_any_policy<T> {
...
template<typename T>
struct big_any_policy CV_FINAL
: typed_base_any_policy <T>
{
...
template<>
inline void big_any_policy<flann_centers_init_t>::print(std::ostream &out, void *const *src) {
