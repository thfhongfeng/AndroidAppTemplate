...
//! @{
        ...
        class CV_EXPORTS_W CharucoDetector
        ...
        CV_WRAP const CharucoParameters
        &

        getCharucoParameters() const;

        CV_WRAP void setCharucoParameters(CharucoParameters & charucoParameters);

        CV_WRAP const DetectorParameters
        &
        ...
        CV_WRAP const RefineParameters
        &

        getRefineParameters() const;
         ...
         */
        CV_WRAP void
        detectBoard(InputArray image, OutputArray charucoCorners, OutputArray charucoIds,
         ...
         */
        CV_WRAP void
        detectDiamonds(InputArray image, OutputArrayOfArrays diamondCorners, OutputArray diamondIds,
                       InputOutputArrayOfArrays markerCorners = noArray(),
 ...
 */
    CV_EXPORTS_W void
    drawDetectedDiamonds(InputOutputArray image, InputArrayOfArrays diamondCorners,
