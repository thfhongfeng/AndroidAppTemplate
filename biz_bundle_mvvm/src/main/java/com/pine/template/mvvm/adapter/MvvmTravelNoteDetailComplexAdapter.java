...
import com.pine.template.mvvm.databinding.MvvmTravelNoteCommentItemBinding;
import com.pine.template.mvvm.databinding.MvvmTravelNoteDayItemBinding;
import com.pine.template.mvvm.databinding.MvvmTravelNoteHeadItemBinding;
...
public class MvvmTravelNoteDetailComplexAdapter extends BaseComplexListAdapter<MvvmTravelNoteDetailEntity, MvvmTravelNoteCommentEntity> {
    ...
    public BaseListViewHolder<String> getEmptyBackgroundViewHolder(ViewGroup parent) {
        return new EmptyBackgroundViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(com.pine.template.base.R.layout.base_item_empty_background, parent, false));
    }
